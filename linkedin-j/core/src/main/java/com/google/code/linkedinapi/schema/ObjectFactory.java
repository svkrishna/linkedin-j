...
import com.google.code.linkedinapi.schema.impl.RenewImpl;
...
public class ObjectFactory {
    ...
    private final static QName _StockExchange_QNAME = new QName("", "stock-exchange");
    ...
    private final static QName _PostingDate_QNAME = new QName("", "posting-date");
    ...
    private final static QName _SalesPersons_QNAME = new QName("", "sales-persons");
    ...
    private final static QName _ExpirationDate_QNAME = new QName("", "expiration-date");
    ...
    public JAXBElement<String> createFeatures(String value) {
        return new JAXBElement<String>(_Features_QNAME, String.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "stock-exchange")
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "posting-date")
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "sales-persons")
    public JAXBElement<String> createSalesPersons(String value) {
        return new JAXBElement<String>(_SalesPersons_QNAME, String.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "expiration-date")
